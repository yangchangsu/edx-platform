# -*- coding: utf-8 -*-
"""Complex chemistry tests for ligands with electrons."""
...
class TestDragAndDropConstraintsLigandsElectrons(unittest.TestCase):
    """Complex chemistry tests for ligands with electrons."""
...
if all(constraints):
    ...
    correct = ['incorrect']
        ...
        user_answer = json.dumps([
            ...
            {"4s": "left-side{0}{9}"},
            {"3d": "left-side{0}{11}"},
            {"e_g_*_1": "center-left{0}{8}"},
            {"d_xy": "center-left{0}{11}"},
            {"sigma_p_*": "center-center{0}{3}"},
            {"sigma_s_*": "center-center{0}{5}"},
            {"e_g_*_label": "center-center{0}{7}"},
            {"t2g_label": "center-center{0}{10}"},
            {"d_yz": "center-center{0}{11}"},
            {"sigma_p": "center-center{0}{14}"},
            {"sigma_d": "center-center{0}{16}"},
            {"sigma_s": "center-center{0}{18}"},
            {"e_g_*_2": "center-right{0}{8}"},
            {"d_xz": "center-right{0}{11}"},
            {"ligands": "right-side{0}{13}"},
            {"up": {"1": {"3d": "left-side{0}{11}"}}},
            {"down": {"1": {"d_xy": "center-left{0}{11}"}}},
            {"up_and_down": {"1": {"sigma_d": "center-center{0}{16}"}}},
            {"up_and_down": {"2": {"sigma_d": "center-center{0}{16}"}}},
            {"up_and_down": {"1": {"sigma_s": "center-center{0}{18}"}}},
            {"up_and_down": {"1": {"ligands": "right-side{0}{13}"}}},
            {"up_and_down": {"2": {"ligands": "right-side{0}{13}"}}},
            {"up_and_down": {"3": {"ligands": "right-side{0}{13}"}}},
            {"up_and_down": {"4": {"ligands": "right-side{0}{13}"}}},
            {"up_and_down": {"5": {"ligands": "right-side{0}{13}"}}},
            {"up_and_down": {"6": {"ligands": "right-side{0}{13}"}}},
            {"up_and_down": {"1": {"sigma_p": "center-center{0}{14}"}}},
            {"up_and_down": {"2": {"sigma_p": "center-center{0}{14}"}}},
            {"up_and_down": {"3": {"sigma_p": "center-center{0}{14}"}}}
        ])
